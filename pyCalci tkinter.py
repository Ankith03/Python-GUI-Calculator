...
def equal_button():
    ...
    try:
        ...
        result = "_ERROR_"
        inputText.set(result)
menubar = Menu(cal,bg="white",fg="grey")
...
inputFrame = Frame(cal, width=312, height=50, bd=0, highlightbackground="white", highlightcolor="crimson", highlightthickness=2)
...
clearall = Button(button_frame, text = "C", fg = "black", width = 10, height = 3, bd = 0, bg = "white", cursor = "hand2", command = lambda: clear_all()).grid(row = 1, column = 0, padx = 1, pady = 1)
